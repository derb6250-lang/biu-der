<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0 0 0 140px","margin":"0","position":"relative","background":"#fafafe","display":"block"} : {"minHeight":"100%","padding":"0","margin":"0 0 0 250px","position":"relative","background":"#FFFFFF","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"padding":"0px 65px","margin":"0 auto","alignItems":"center","left":"0","background":"linear-gradient( 180deg, #52B3EA 0%, #0067A2 100%)","display":"flex","width":"100%","position":"fixed","justifyContent":"flex-end","zIndex":"222","height":"75px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"width":"calc(100% - 60px)","padding":"95px 10px 0 0","margin":"0 auto","borderRadius":"0px","background":"none"}' class="bread-crumbs"></bread-crumbs>
