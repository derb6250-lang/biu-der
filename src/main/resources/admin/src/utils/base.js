const base = {
	get() {
		return {
			url : "http://localhost:8080/ershoujiao58xrq5r2/",
			name: "ershoujiao58xrq5r2",
			// 退出到首页链接
			indexUrl: 'http://localhost:8080/ershoujiao58xrq5r2/front/dist/index.html'
		};
	},
	getProjectName(){
		return {
			projectName: "二手羽毛球装备交易系统"
		} 
	},
	getUsersName(){
		return {
