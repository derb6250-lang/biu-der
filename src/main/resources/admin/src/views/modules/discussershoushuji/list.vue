	...
	<div class="main-content" :style='{"padding":"50px 30px 30px"}'>
		...
		<template v-if="showFlag ">
			<el-form class="center-form-pv" :style='{"width":"100%","padding":"0","margin":"0 0 20px"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"padding":"20px 20px 10px","borderRadius":"8px  8px  8px  8px","flexWrap":"wrap","background":"#F5F5F5","display":"flex","width":"100%","position":"relative"}'>
					<el-button :style='{"border":"1px solid #09A5FF","cursor":"pointer","padding":"0 12px 0 10px","boxShadow":" inset 0px 3px 6px 1px #9ADAFF","outline":"none","color":"#fff","borderRadius":"8px 8px 8px 8px","background":" linear-gradient( 180deg, #0098EF 0%, #0075B8 100%)","width":"122px","fontSize":"16px","height":"42px"}' type="success" @click="backClick()">返回</el-button>
				</el-row>

				<el-row class="actions" :style='{"width":"calc(100% + 8px)","margin":"20px 0 20px -4px","flexWrap":"wrap","justifyContent":"flex-end","display":"flex"}'>
					<el-button class="add" v-if="isAuth('discussershoushuji','新增')" type="success" @click="addOrUpdateHandler()">
						<span class="icon iconfont icon-tianjia16" :style='{"margin":"0 0px","fontSize":"16px","color":"#0098EF","height":"auto"}'></span>
						添加
					</el-button>
					<el-button class="del" v-if="isAuth('discussershoushuji','删除')" :disabled="dataListSelections.length?false:true" type="danger" @click="deleteHandler()">
			...
			<div :style='{"border":"1px solid #DEDEDE","width":"100%","padding":"0","boxShadow":"none","borderRadius":"10px","background":"#fff"}'>
				<el-table class="tables"
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button class="edit" v-if=" isAuth('discussershoushuji','修改') " type="success" @click="addOrUpdateHandler(scope.row.id)">
							...
							<el-button class="view" v-if="isAuth('discussershoushuji','查看评论')" type="success" @click="disscussListHandler(scope.row.id)">
							...
							<el-button class="del" v-if="isAuth('ershoushuji','删除评论')" type="primary" @click="deleteHandler(scope.row.id ,scope.row.refid)">
