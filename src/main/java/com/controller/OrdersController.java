...
public class OrdersController {
    ...
    public R page(@RequestParam Map<String, Object> params,OrdersEntity orders,
		...
		if(tableName.equals("yonghu")) {
			orders.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
    ...
    public R mchList(@RequestParam Map<String, Object> params,OrdersEntity orders,HttpServletRequest request){
        ...
        wrapper.or().eq("yonghuzhanghao",(String)request.getSession().getAttribute("username"));
        //查询结果
    ...
    public R count(@RequestParam Map<String, Object> params,OrdersEntity orders, @RequestParam(required = false) String conditionColumn, @RequestParam(required = false) String conditionValue,  HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("yonghu")) {
            orders.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
        }
